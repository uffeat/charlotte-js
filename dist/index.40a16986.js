...
})({"2MpKh":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "138dd62c40a16986";
"use strict";
...
},{}],"5zXG3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _alertJs = require("../../../.build/alert.js");
parcelHelpers.exportAll(_alertJs, exports);

},{"../../../.build/alert.js":"c6WFn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c6WFn":[function(require,module,exports) {
// Transcrypt'ed from Python, 2023-04-22 23:56:38
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Alert", ()=>Alert);
var _orgTranscryptRuntimeJs = require("./org.transcrypt.__runtime__.js");
var __name__ = "__main__";
var Alert = (0, _orgTranscryptRuntimeJs.__class__)("Alert", [
    (0, _orgTranscryptRuntimeJs.object)
], {
    __module__: __name__,
    get __init__ () {
        return (0, _orgTranscryptRuntimeJs.__get__)(this, function(self) {
            (0, _orgTranscryptRuntimeJs.print)("PyComponent init");
            self._stuff = null;
        });
    },
    get _get_stuff () {
    ...
    get get_stuff () {
        return (0, _orgTranscryptRuntimeJs.__get__)(this, function(self) {
            (0, _orgTranscryptRuntimeJs.print)("`stuff` getter called. Returning value: {}".format(self._stuff));
            return self._stuff;
        });
    },
    get _set_stuff () {
        return (0, _orgTranscryptRuntimeJs.__get__)(this, function(self, stuff) {
            self.set_stuff(stuff);
        });
    },
    get set_stuff () {
        return (0, _orgTranscryptRuntimeJs.__get__)(this, function(self, stuff) {
            (0, _orgTranscryptRuntimeJs.print)("`stuff` setter called with value `{}`.".format(stuff));
            self._stuff = stuff;
        });
    },
    get print_some_text () {
        return (0, _orgTranscryptRuntimeJs.__get__)(this, function(self, text) {
            (0, _orgTranscryptRuntimeJs.print)("Some text: {}".format(text));
        });
    },
    get print_my_text () {
        return (0, _orgTranscryptRuntimeJs.__get__)(this, function(self) {
            (0, _orgTranscryptRuntimeJs.print)(self.textContent);
        });
    }
});
Object.defineProperty(Alert, "stuff", (0, _orgTranscryptRuntimeJs.property).call(Alert, Alert._get_stuff, Alert._set_stuff));
...
// Transcrypt'ed from Python, 2023-04-23 00:02:26
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["2MpKh","5zXG3"], "5zXG3", "parcelRequireca93")

//# sourceMappingURL=index.40a16986.js.map
